...
export default function Faq() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes, we provide free parking for guests."
    },
    {
      question: "What is the check-out time?",
      answer: "Check-out time is 11:00 AM. Late check-out is subject to availability."
    },
    {
      question: "Do you offer complimentary breakfast?",
      answer: "Yes, complimentary breakfast is provided for all guests staying with us."
    },
    {
      question: "Is Wi-Fi available?",
      answer: "Yes, we offer free high-speed Wi-Fi throughout the property."
    },
    {
    ...
    },
    {
      ...
      answer: "Unfortunately, pets are not allowed at Lumarise Residency."
    },
    {
      question: "Does the hotel provide airport/station pickup?",
      answer: "Yes, pickup and drop services are available on request with additional charges."
    },
    {
      question: "Do you have hot water facility?",
      answer: "Yes, 24/7 hot water is available in all bathrooms."
    },
    {
      question: "Is smoking allowed inside the rooms?",
      answer: "No, smoking is strictly prohibited inside rooms. A designated smoking area is available."
    },
    {
      question: "How can I modify or cancel my booking?",
      answer: "You can contact our reception desk or WhatsApp us directly using the number on the Contact page."
    },
    {
      question: "Do you offer room service?",
      answer: "Yes, room service is available from 7:00 AM to 10:00 PM."
    },
    {
      question: "Are extra beds available?",
      answer: "Yes, extra beds can be provided upon request for an additional charge."
    },
    {
      question: "Do you have CCTV surveillance?",
      answer: "Yes, the entire property is secured with 24/7 CCTV monitoring for guest safety."
    },
    {
      question: "Is there a restaurant inside the hotel?",
      answer: "We have an in-house dining area with both veg and non-veg options available."
    }
  ];
        ...
        <div className="mt-10 sm:mt-12 bg-slate-800 text-white rounded-lg p-6 sm:p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <button 
              ...
              className="w-full sm:w-auto bg-[#f5d36c] hover:bg-[#e0c45a] active:bg-[#d3af44] text-black px-6 sm:px-8 py-3 uppercase tracking-widest text-xs sm:text-sm font-semibold transition-all duration-300 shadow-md hover:shadow-lg active:scale-98 rounded-lg"
