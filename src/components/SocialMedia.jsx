...
export default function FloatingSocialMedia() {
  ...
  const socialLinks = [
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/lumarisehotels?igsh=c3NhcHhjOTl4OWxq&utm_source=qr',
      icon: (
    ...
    {
      name: 'Facebook',
      url: 'https://www.facebook.com/share/17m7XUM9qq/?mibextid=wwXIfr',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Google Review',
      url: 'https://www.google.com/maps/place/Lumarise+Hotel/',
      icon: <Globe size={24} />,
      ...
      <div className="flex flex-col gap-3">
        {socialLinks.map((social, index) => (
          <a
            ...
            className={`w-12 h-12 flex items-center justify-center rounded-full bg-white text-[#d4af37] shadow-lg transition-all duration-300 ${social.color} hover:text-white transform hover:scale-110`}
